		...
		<div class="sidebar-wrapper" data-simplebar="true" style="background-color: rgb(29, 29, 59);">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{route('add_recipe')}}"><i class="bx bx-right-arrow-alt"></i>Add Recipe</a>
						</li>
						<li> <a href="{{route('leave_date')}}"><i class="bx bx-right-arrow-alt"></i>Leave Management</a>
						</li>

                        <li> <a href="{{route('kitchen')}}"><i class="bx bx-right-arrow-alt"></i>Kitchen Registration</a>
						</li>
