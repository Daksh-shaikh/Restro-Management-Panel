                        ...
                        @endif
								...
								<form class="row g-2" action="{{route('restroUpdate')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-2">
										...
										<input type="text" class="form-control" id="address"
											aria-describedby="emailHelp" placeholder="" name="address"  autocomplete="on" value="{{$restroEdit->address}}">
                                    ...
                                    readonly required value="{{$restroEdit->latitude}}">
									...
									<div class="col-lg-2">
                                        ...
                                        readonly required value="{{$restroEdit->longitude}}">
									</div>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select class="multiple-select" multiple="multiple" name="category[]">
                                        @foreach ($category as $category_name)
                                            <option value="{{ $category_name->id }}" {{ in_array($category_name->id, $restroEdit->category_name->pluck('id')->toArray()) ? 'selected' : '' }}>{{ $category_name->category }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-1" style="margin-top: 35px;">
                                    <input class="form-check-input" type="checkbox" value="Veg" name="food[]" id="flexCheckDefault"
                                        @if(in_array('Veg', explode(',', $restroEdit->food))) checked @endif>
                                ...
                                <div class="col-lg-1" style="margin-top: 35px;">
                                    <input class="form-check-input" type="checkbox" value="Non-Veg" name="food[]" id="flexCheckDefault1"
                                        @if(in_array('Non-Veg', explode(',', $restroEdit->food))) checked @endif>
    ...
    @foreach ($days as $day)
        ...
        <div class="col-lg-2">
            <div style="position: relative; margin-top:15px">
                ...
                <input type="time" name="open_at_{{ $day->id }}" id="open_at_{{ $day->id }}" class="form-control" style="height: 50px;" value="{{ $timeSlots[$day->id]->open_at }}">
            </div>
        </div>
        ...
        <div class="col-lg-2">
            <div style="position: relative; margin-left: 10px; margin-top:15px">
                ...
                <input type="time" name="close_at_{{ $day->id }}" id="close_at_{{ $day->id }}" class="form-control" style="height: 50px;" value="{{ $timeSlots[$day->id]->close_at }}">
            </div>
        </div>
        <div></div>
    @endforeach
